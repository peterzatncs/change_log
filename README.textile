...
* Note: If you use bundler with Rails 2.3.x, you may get "enable_change_log" method missing error. 
        ...
        Visit http://gembundler.com/rails23.html to find out how.
...
h2. Use Change Log
    ...
    1. Include change_log in environment.rb (if you are not using bundler)
<pre><code>config.gem 'change_log'</code></pre>
